...
// esquema del articulo, le agregamos el campo de imagen
const ArticuloSchema: Schema = new Schema({
    ...
    imagen: { type: String, default: "" } // si no sube nada se queda vacio
});

export default mongoose.model<IArticulo>("ArticuloFront", ArticuloSchema);
